...
# use_voice = st.checkbox("🎤 Use voice input (no PyAudio!)")
...
#             except sr.RequestError:
#                 st.error("Could not request results from Google API")
# else:
#     question = st.text_input("Ask a question about the image")
...
question = ""
use_voice = st.checkbox("🎤 Use voice input (no PyAudio required)")
